  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li><a href="?page=anggota"><i class="glyphicon glyphicon-list-alt"></i> Inisial</a></li>
        <li><a href="?page=laporan"><i class="glyphicon glyphicon-file"></i> Manager Data</a></li>
...
<footer class="container-fluid">
  <p>&copy; MAPAN <a href="#" target="_blank"></a></p>
</footer>
<?php } ?>
</body>
</html>
